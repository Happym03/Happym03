...
and scoring models - ISO 27001 control assessment frameworks - Compliance mapping
and gap analysis - Treatment planning and vendor assessment - Business continuity
...
South African insurance brokerage.
20 integrated GRC deliverables:
• Executive summary and governance charter
• Risk assessment and risk register (14 identified risks)
• Risk treatment plan with mitigation roadmap
• Risk appetite and tolerance statement
• RACI matrix and governance structures
• Asset and control registers
• ISO/IEC 27001:2022 Annex A assessment (all 93 controls mapped)
• Control effectiveness scoring
• POPIA privacy impact assessment
• FAIS and TCF compliance documentation
• Third-party vendor risk assessment
• Business Impact Analysis (BIA)
• Incident-response playbooks (ransomware, data breach)
...
Demonstrates sector transferability:
• POPIA special personal information
• Clinical information systems and medical devices
• Patient safety and healthcare operations
• Ransomware and data breach scenarios
• Business continuity for critical clinical services
• Operational resilience and disaster recovery
• Incident response specific to healthcare
Deliverables: - Governance and risk framework - Healthcare-specific risk assessment -
ISO 27001 gap assessment adapted for healthcare - POPIA compliance for patient
records - Medical-device security risk register - Ransomware response playbooks -
...
design.
Security & Privacy themes: - Privacy-by-design principles - Data minimisation (local
storage only, no cloud account) - Sensitive-information protection - User security controls -
...
• Sanlam — Insurance services, regulatory compliance
• OUTsurance — Commercial insurance, risk assessment
• Tracker Connect — Service management, case handling, customer data
...
• Risk analytics and data-driven decision-making
